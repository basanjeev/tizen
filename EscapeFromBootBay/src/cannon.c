...
static void
_cannon_del_cb(void *data , Evas *e , Evas_Object *obj,
               void *event_info )
{
...
static void
_cannon_empty_cb(void *data, Evas_Object *obj ,
...
cannon_add(Evas_Object *win)
{
   ...
   char path[1024]; snprintf(path, 1025, "%s/%s.edj", app_get_resource_path(), GAME_THEME);
   edje_object_file_set(cannon, path, "cannon");
