...
static void
_menu_cb(void *data, Evas_Object *obj ,
...
static void
_level_selected(void *data, Evas_Object *obj , void *event_info)
{
...
static char *
_grid_text_get(void *data, Evas_Object *obj ,
               const char *part )
{
   Level *level = data;
   char name[32];
                        ...
                        Etrophy_Gamescore *gamescore, Eina_List *levels)
{
   ...
   elm_layout_file_set(level_select_screen, path, "lvlsel_win");
