...
static Eina_Bool
_sound_repeat_cb(void *data , int type , void *event)
{
...
static void
_sound_repeat_free(void *userdata , void *data)
{
...
static void
_sound_finished_cb(ca_context *c , uint32_t id ,
...
void
sound_play_cb(void *data , Evas_Object *o ,
