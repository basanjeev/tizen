...
static tinnos_signal_s cache[Signal_Max] = {
		{Signal_Body_Lights_IsLowBeamOn, 								BOOL, 	false, 	"Beam", 	"%s", 			"N/A", "    LowBeam : %s      ", 		{.b = false}},
		{Signal_Drivetrain_BatteryManagement_BatteryStatus,				BOOL, 	false, 	"Btry", 	"%s", 			"N/A", "    BatteryStatus : %s",		{.b = false}},
		{Signal_Drivetrain_Transmission_Speed,							INT, 	false, 	"kmph", 	"%d", 			"N/A", "    Tx Speed %d kmph  ",		{.i = 0}},
		{Signal_Drivetrain_InternalCombustionEngine_OilGauge,			BOOL, 	false, 	"Oil", 		"%s", 			"N/A", "    OilGauge %s       ",		{.b = false}},
		{Signal_Chassis_Axle_Row1_Wheel_Right_Tire_Pressure,			DOUBLE, false, 	"psi", 		"%3.2f", 		"N/A", "    Row1->psi %3.2f   ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row1_Wheel_Right_Tire_PressureLow,			BOOL, 	false, 	"1R", 		"%s", 			"N/A", "    Row1->IsLow %s    ",		{.b = false}},
		{Signal_Chassis_Axle_Row1_Wheel_Right_Tire_Temperature,			DOUBLE,	false, 	"°C", 		"%3.2f", 		"N/A", "    Row1->°C %3.2f    ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row1_Wheel_Left_Tire_Pressure,				DOUBLE, false, 	"psi", 		"%3.2f", 		"N/A", "    Row1<-psi %3.2f   ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row1_Wheel_Left_Tire_PressureLow,			BOOL, 	false, 	"1L", 		"%s", 			"N/A", "    Row1<-IsLow %s    ",		{.b = false}},
		{Signal_Chassis_Axle_Row1_Wheel_Left_Tire_Temperature,			DOUBLE,	false, 	"°C", 		"%3.2f", 		"N/A", "    Row1<-°C %3.2f    ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row2_Wheel_Right_Tire_Pressure,			DOUBLE, false, 	"psi", 		"%3.2f", 		"N/A", "    Row2<-psi %3.2f   ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row2_Wheel_Right_Tire_PressureLow,			BOOL, 	false, 	"2R", 		"%s", 			"N/A", "    Row2->IsLow %s    ",		{.b = false}},
		{Signal_Chassis_Axle_Row2_Wheel_Right_Tire_Temperature,			DOUBLE,	false, 	"°C", 		"%3.2f", 		"N/A", "    Row2->°C %3.2f    ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row2_Wheel_Left_Tire_Pressure,				DOUBLE, false, 	"psi", 		"%3.2f", 		"N/A", "    Row2->psi %3.2f   ",		{.d = 0.00}},
		{Signal_Chassis_Axle_Row2_Wheel_Left_Tire_PressureLow,			BOOL, 	false, 	"2L", 		"%s", 			"N/A", "    Row2<-IsLow %s    ",		{.b = false}},
		{Signal_Chassis_Axle_Row2_Wheel_Left_Tire_Temperature,			DOUBLE,	false, 	"°C", 		"%3.2f", 		"N/A", "    Row2<-°C %3.2f    ",		{.d = 0.00}},
		{Signal_Drivetrain_FuelSystem_Level,							INT, 	false, 	"lts", 		"%d", 			"N/A", "    Fuel Level    %d l",		{.i = 0}},
		{Signal_Body_Outside_Temperature,								DOUBLE,	false, 	"°C", 		"%3.2f",		"N/A", "    Out Temp %3.2f    ",		{.d = 0.00}},
		{Signal_Body_Lights_IsParkingOn,								BOOL, 	false, 	"Park", 	"%s", 			"N/A", "    Parking        %s ",		{.b = false}},
		{Signal_Drivetrain_InternalCombustionEngine_EOP,				BOOL, 	false, 	"EOP", 		"%s", 			"N/A", "    Engine Oil PSI %s ",		{.b = false}}
};
